...
func sendSuccessProdDeploy(user, url string) (err error) {
...
func sendFailedProdDeploy(deployErr error) (err error) {
...
func sendAttemptDeployMessage() (ts string, err error) {
	msg := getAttemptDeployMessage()
...
func getAttemptDeployMessage() SlackMessage {
...
func sendDeploySuccessMessage(ts, url string) (err error) {
	msg := getDeploySuccessMessage(url)
...
func getDeploySuccessMessage(url string) SlackMessage {
...
func sendFailedDeployMessage(ts string, deployErr error) (err error) {
	msg := getFailedDeployMessage(deployErr)
...
func getFailedDeployMessage(err error) SlackMessage {
...
func sendOwnerMessages(url string) (errs []error) {
	// func sendOwnerMessages(build Build, url string) (payload actionPayload, errs []error) {
	// 	var oMsgs []ownerMsg
	//
...
func getOwnerMessage(url string) (SlackMessage, error) {
...
func sendQaMessages(url string) (errs []error) {
...
func getQAMessage(url string) (SlackMessage, error) {
...
func getQaSlackAttachment() SlackAttachment {
